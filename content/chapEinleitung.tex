...
Parallel dazu zeigen Matryoshka-Embeddings, dass Modelle so trainiert werden können, dass auch reduzierte Embedding-Dimensionen noch leistungsfähig bleiben.
\par
Aus dieser Ausgangslage ergibt sich die zentrale Forschungsfrage der Arbeit:
Welche Auswirkungen haben Bit-Repräsentationen auf Speicherbedarf, Suchgeschwindigkeit und Retrieval-Qualität im Vergleich zu Float-Embeddings, und unter welchen Bedingungen ist ein hybrider, zweistufiger Ansatz sinnvoll?
Der Fokus liegt damit nicht auf einer bloßen Implementierung eines weiteren Suchsystems, sondern auf dem wissenschaftlichen Vergleich unterschiedlicher Repräsentations- und Indexierungsstrategien.