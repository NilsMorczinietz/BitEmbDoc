...
Sie ist aufgabenunabhängig im Sinne, dass keine überwachte oder aufgabenspezifische Optimierung stattfindet -- die Hauptkomponenten werden zwar aus den Daten geschätzt, aber ohne Kenntnis der Retrieval-Aufgabe oder Relevanzurteile.
Zudem ist sie orthogonal zur anschließenden Quantisierung, sodass beide Effekte weiterhin separierbar bleiben.
...
Für ein Retrieval-System ist es gravierender, irrelevante Dokumente anzuzeigen (niedriges Trustworthiness), als einzelne relevante Dokumente zu übersehen (niedrige Continuity), solange genügend relevante Treffer verbleiben -- was der Recall in Phase~4 direkt überprüft.
%
