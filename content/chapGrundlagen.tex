...
Unabhängig vom Trainingverfahren lässt sich das Prinzip der Dimensionsreduktion jedoch auch nachträglich anwenden:
Eine PCA-Projektion auf die informationsreichsten Dimensionen ist konzeptionell analog zum Matryoshka-Präfix, operiert aber auf einem nicht-speziell-trainierten Raum und ermöglicht damit die Untersuchung, wie viel Redundanz ein Standard-Embedding-Modell über seine Dimensionen verteilt.
%
