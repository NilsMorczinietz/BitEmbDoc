...
\begin{itemize}
  ...
  \item \textbf{Google Antigravity CLI} (Google, 2026)
...
\vspace{1.5cm}
\noindent\rule{0.38\textwidth}{0.4pt}\hfill\rule{0.5\textwidth}{0.4pt}\\[2pt]
\noindent\makebox[0.38\textwidth][c]{Ort, Datum}\hfill\makebox[0.5\textwidth][c]{Unterschrift}
